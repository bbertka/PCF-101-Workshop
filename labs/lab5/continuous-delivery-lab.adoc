...
. If your Jenkins Instance is configured for a Proxy (eg. 100.115.73.81:443), enter  `-Dhttp.proxyHost=100.115.73.81 -Dhttp.proxyPort=443 -Dhttps.proxyHost=100.115.73.81 -Dhttps.proxyPort=443`
